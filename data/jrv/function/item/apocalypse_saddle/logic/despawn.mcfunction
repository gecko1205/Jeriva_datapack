summon item ~ ~ ~ {Item:{id:"jigsaw",count:1,components:{"minecraft:consumable":{consume_seconds:0.5,animation:"brush",sound:"intentionally_empty",has_consume_particles:false},"minecraft:item_model":"jrv:apocalypse_saddle/normal","minecraft:custom_data":{item:apocalypse_saddle},"minecraft:item_name":'"Sela do apocalipse"',"minecraft:rarity":"epic","minecraft:use_cooldown":{seconds:3,cooldown_group:"apocalypse_saddle"}}},Tags:["jrv.item.apocalypse_saddle.drop"]}
