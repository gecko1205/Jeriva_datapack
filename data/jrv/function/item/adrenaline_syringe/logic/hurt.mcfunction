...
effect give @s minecraft:strength 4 1 false
...
execute if items entity @s weapon.offhand jigsaw[custom_data={item:adrenaline_syringe}] run return run item replace entity @s weapon.offhand with jigsaw[item_model="jrv:adrenaline_syringe/normal",custom_data={item:adrenaline_syringe},item_name='"Seringa de adrenalina"',rarity="epic",use_cooldown={seconds:1,cooldown_group:"adrenaline_syringe"},max_damage=6,damage=6,max_stack_size=1,consumable={animation:"bow",consume_seconds:2,has_consume_particles:false,sound:"block.pointed_dripstone.drip_water"},lore=['{"color":"gray","text":"Recarregue para usar","italic":false}'],use_remainder={id:"jigsaw",components:{item_model:"jrv:adrenaline_syringe/normal",custom_data:{item:adrenaline_syringe},item_name:'"Seringa de adrenalina"',rarity:"epic",use_cooldown:{seconds:1,cooldown_group:"adrenaline_syringe"},max_damage:6,damage:5,max_stack_size:1,lore:['{"color":"gray","text":"Recarregando...","italic":false}']}}] 1
