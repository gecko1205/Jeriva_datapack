...
execute as @e[distance=..2.5,tag=!jrv.item.echo_sword.attacker,tag=!jrv.item.echo_sword.hit,tag=!jrv.item.echo_sword.axe] run function jrv:item/echo_sword/logic/sonic_boom/hit
