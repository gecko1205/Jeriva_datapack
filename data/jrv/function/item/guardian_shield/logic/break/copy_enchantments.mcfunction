...
give @s jigsaw[item_model="jrv:guardian_shield/shield",item_name='{"text":"Escudo do Guardião","color":"gold"}',tooltip_style="jrv:exclusive/tooltip",custom_data={item:guardian_shield,broken:true},enchantment_glint_override=false,repairable={items:["shield","pale_oak_planks","oak_planks","birch_planks","acacia_planks","bamboo_planks","cherry_planks","jungle_planks","spruce_planks","warped_planks","crimson_planks","dark_oak_planks","mangrove_planks"]},max_damage=168,damage=168,max_stack_size=1] 1