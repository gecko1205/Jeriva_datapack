...
summon item_display ~ ~ ~ {Glowing:1b,Tags:["jrv.item.building_wand.display","jrv.item.building_wand.pos2","jrv.item.building_wand.pos"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1.01f,1.01f,1.01f]},item:{id:"minecraft:paper",count:1,components:{"minecraft:item_model":"jrv:building_wand/selection/blue_overlay"}}}
