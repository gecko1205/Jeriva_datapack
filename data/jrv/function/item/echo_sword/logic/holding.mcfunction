...
execute if score hold jrv.item.echo_sword matches -1 if score hits jrv.item.echo_sword matches 10 run title @s actionbar ["",{"text":"• • • • • • • • • • ","color":"#2bd9e0"},{"text":"• •","color":"dark_gray"}]
execute if score hold jrv.item.echo_sword matches -1 if score hits jrv.item.echo_sword matches 11 run title @s actionbar ["",{"text":"• • • • • • • • • • • ","color":"#2bd9e0"},{"text":"•","color":"dark_gray"}]
