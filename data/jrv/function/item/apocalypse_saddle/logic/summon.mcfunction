...
summon zombie_horse ~ ~ ~ {Invulnerable:1b,DeathLootTable:"minecraft:empty",NoAI:1b,Health:1f,Tame:1b,Tags:["jrv.item.apocalypse_saddle.horse","jrv.item.apocalypse_saddle.safe"],attributes:[{id:"minecraft:jump_strength",base:0.7},{id:"minecraft:max_health",base:1},{id:"minecraft:movement_speed",base:0.5}],SaddleItem:{id:"minecraft:saddle",count:1b,components:{custom_data:{jrv.item.apocalypse_saddle.saddle_item:true},item_model:"jrv:apocalypse_saddle/normal",item_name:'{"text":"Sela do Apocalipse","color":"gold"}',tooltip_style:"jrv:exclusive/tooltip"}}}
